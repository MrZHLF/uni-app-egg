                      ...
                      _c(
                        ...
                        [
                          _c("u-image", {
                            ...
                            attrs: { src: "../../static/gift/7.png", mode: "" }
                          })
                        ],
                        1
                      ),
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _fGift = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-gift.vue */ 10));\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! @/components/uni-ui/uni-popup/uni-popup.vue */ 16));\nvar _fDanmu = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-danmu.vue */ 33));\nvar _gifts = _interopRequireDefault(__webpack_require__(/*! @/demo/gifts.js */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { data: function data() {return { statusBarHeight: 0, content: \"\", gifts: [], giftActiveId: 0, mode: \"SD\", enableCamera: true, position: \"back\", beauty: 0, //美颜\n      whiteness: 0, //美白\n      windowHeight: 0, context: null, modeList: [{ type: \"SD\", desc: \"标清\" }, { type: \"HD\", desc: \"高清\" }, { type: \"FHD\", desc: \"超清\" }], popupType: \"mode\", btns: [{ name: \"翻转\", icon: \"\\uE605\", event: \"switchCamera\" }, { name: \"画质\", icon: \"\\uE60C\", event: \"openPopup\", params: \"mode\" }, { name: \"美颜\", icon: \"\\uE632\", event: \"openPopup\", params: \"beauty\" }, { name: \"美白\", icon: \"\\uE631\", event: \"openPopup\", params: \"whiteness\" }, { name: \"更多\", icon: \"\\uE84B\", event: \"openPopup\", params: \"more\" }], isPause: true };}, components: { fGift: _fGift.default, uniPopup: _uniPopup.default, fDanmu: _fDanmu.default }, onLoad: function onLoad(e) {var res = uni.getSystemInfoSync();this.statusBarHeight = res.statusBarHeight;this.windowHeight = res.windowHeight;var options = JSON.parse(e.options);this.mode = options.mode;this.position = options.position;this.beauty = options.beauty;this.whiteness = options.whiteness; // 礼物数据\n    this.gifts = _gifts.default;}, onReady: function onReady() {this.context = uni.createLivePusherContext('livePusher', this);this.startPreview();}, computed: { popupTitle: function popupTitle() {var o = { mode: \"画质\", beauty: \"美颜\", whiteness: \"美白\", more: \"更多\" };return o[this.popupType];} }, methods: { pauseOrPlay: function pauseOrPlay() {}, back: function back() {uni.showModal({ content: '是否要退出直播间？', success: function success(res) {if (res.cancel) {return;}uni.navigateBack({ delta: 1 });uni.showToast({ title: '退出直播间成功', icon: 'none' });} });}, handleBottomEvent: function handleBottomEvent(item) {this[item.event](item.params);}, // 开启预览\n    startPreview: function startPreview() {this.context.startPreview({ success: function success(e) {__f__(\"log\", e, \" at pages/liveroom/liveroom.nvue:249\");} });}, handleSliderChange: function handleSliderChange(e) {// 美颜设置\n      this[this.popupType] = e.detail.value;}, chooseMode: function chooseMode(item) {// 画质选择\n      uni.showToast({\n        title: \"画质切换为\" + item.desc,\n        icon: \"none\" });\n\n      this.mode = item.desc;\n      this.$refs.popup.close();\n    },\n    switchCamera: function switchCamera() {var _this = this;\n      // 切换摄像头\n      this.context.switchCamera({\n        success: function success(e) {\n          _this.position = _this.position == 'back' ? 'front' : 'back';\n        } });\n\n\n    },\n    openPopup: function openPopup(type) {\n      // 画质\n      this.popupType = type;\n      this.$refs.popup.open();\n    },\n    closePopup: function closePopup() {\n      this.$refs.popup.close();\n    },\n    statechange: function statechange(e) {\n      //直播状态变化\n      __f__(\"log\", e, \" at pages/liveroom/liveroom.nvue:285\");\n    },\n    netstatus: function netstatus(e) {\n      // 直播网络变化\n      __f__(\"log\", e, \" at pages/liveroom/liveroom.nvue:289\");\n    },\n    error: function error(e) {\n      // 监听错误\n      __f__(\"log\", e, \" at pages/liveroom/liveroom.nvue:293\");\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 9)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///8\n");
...
/* 38 */
/*!************************************************!*\
  !*** F:/uni-app/uni-zhibo/直播APP/demo/gifts.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
